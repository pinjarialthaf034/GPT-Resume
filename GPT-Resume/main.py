...
if groq_key:
    print("✅ [SUCCESS] Loaded GROQ_API_KEY", flush=True)
else:
...
# Configure explicit allowed origins for CORS
ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://localhost:5500",
    ...
    "http://localhost:8001",
    "http://127.0.0.1:8001",
    "https://gpt-resume.netlify.app",
    "https://gpt-career.netlify.app",
]

env_cors = os.getenv("CORS_ORIGINS", "")
if env_cors:
    for o in env_cors.split(","):
        cleaned_origin = o.strip()
